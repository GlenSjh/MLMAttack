...
from textattack.metrics.quality_metrics import Perplexity, USEMetric, GrammarMetric, BertScoreMetric
...
class AttackLogManager:
    ...
    def log_summary(self):
        ...
        if self.enable_advance_metrics:
            ...
            grammar_stats = GrammarMetric().calculate(self.results)
            bert_score_stats = BertScoreMetric().calculate(self.results)
            ...
            summary_table_rows.append(
                [
                    "Average Original Grammar Error:",
                    grammar_stats["avg_original_grammar"],
                ]
            )

            summary_table_rows.append(
                [
                    "Average Attack Grammar Error:",
                    grammar_stats["avg_attack_grammar"],
                ]
            )

            summary_table_rows.append(
                ["Average Attack Bert Score:", bert_score_stats["avg_attack_bert_score"]]
            )
